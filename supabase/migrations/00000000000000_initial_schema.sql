...
CREATE TABLE students (
  ...
  city                    TEXT,
  postcode                TEXT,
  -- Address source: either a guardian reference or own address fields (enforced by CHECK)
...
-- Migrates students from one class to a new class, deactivating the source.
